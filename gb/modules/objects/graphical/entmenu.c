...
#define entmenu_pos(self)          (self->pos)
#define entmenu_pos_x(self)        point_x(entmenu_pos(self))
#define entmenu_pos_y(self)        point_y(entmenu_pos(self))
...
#define entmenu_selection(self)    menu_selection(entmenu_menu(self))
...
#define entmenu_select(self)       menu_select(entmenu_menu(self),0)
#define entmenu_cursor_left(self)  menu_cursor_left(entmenu_menu(self))
#define entmenu_cursor_right(self) menu_cursor_right(entmenu_menu(self))
...
void entmenu_draw( entmenu_t * self ) {
  ...
  loop(j,entmenu_maxlines(self)) {
    gb_draw_text( entmenu_pos_x(self)+10,
      entmenu_pos_y(self)+10+(10*j),
