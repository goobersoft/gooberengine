...
const gb_mouse_gfx_tile_id				:int 		= 0
const gb_mouse_gfx_tile_x 				:int 		= 4
const gb_mouse_gfx_tile_y 				:int 		= 20
...
function gb_mouse_update()
  local d:float   = gb_delta()
	...
	point_set(gb_mouse_pos, gb_mouse_tile_x(), gb_mouse_tile_y())
	...
	if mousedown(1)
		if int_eq(gb_mouse_click,0)
			...
			point_set(gb_mouse_clickpos, gb_mouse_tile_x(), gb_mouse_tile_y())
...
function gb_mouse_draw(x:float=0, y:float=0)
	if bool_eq(gb_mouse_visible,true)
		...
		gb_graph_draw_tile(gb_mouse_clickpos.x-0.5, gb_mouse_clickpos.y-0.5,
			0, gb_mouse_gfx_tile_x + 1 + ffloor(gb_mouse_clicktime.value),
			gb_mouse_gfx_tile_y)
		...
		if number_gt(gb_mouse_idletime,0.5)
			gb_graph_draw_tile(gb_mouse_tile_x(), gb_mouse_tile_y(),
				0, ux, uy)
