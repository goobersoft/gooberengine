...
#define brickerui_leddisplay(self) (self->leddisplay)
...
void brickerui_update( brickerui_t * self ) {
  ...
  leddisplay_update( brickerui_leddisplay(self) );
...
void brickerui_draw( brickerui_t * self ) {
  ...
  // draw the leddisplay
  leddisplay_draw( brickerui_leddisplay(self) );
}